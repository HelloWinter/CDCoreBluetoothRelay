...
class RP5ConfigurePannelView: UIImageView {
    ...
    private lazy var dragImageView : UIImageView = {
        ...
        imgV.image = UIImage(named: "rp5_configurepannel_header")
        return imgV
    }()
    
    private lazy var pannelDownView : UIImageView = {
        let imgV = UIImageView(frame: .zero)
        imgV.image = UIImage(named: "rp5_configurepannel_footer")
        return imgV
    }()
    ...
    override func layoutSubviews() {
        ...
        let pannelDownWidth = imgWidth
        let pannelDownHeight = pannelDownWidth * 7 / 10
        pannelDownView.frame = CGRect(x: 00, y: ScreenHeight - pannelDownHeight, width: pannelDownWidth, height: pannelDownHeight)
